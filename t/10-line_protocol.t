...
is(InfluxDB::Client::Simple::_line_protocol($m, \%tags, \%fields, 1610462906000), 'test,a_tag=1,b_tag=3,c_tag=2 a_val=1i,b_val=1.3,c_val="toto" 1610462906000');
...
is(InfluxDB::Client::Simple::_line_protocol($m, { %tags, b_tag=>0 }, \%fields, 1610462906000), 'test,a_tag=1,b_tag=0,c_tag=2 a_val=1i,b_val=1.3,c_val="toto",notignored="" 1610462906000');
